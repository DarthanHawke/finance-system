...
import (
	...
	"os"
	"os/signal"
	ssoapp "rebac-service/internal/app"
	"rebac-service/internal/config"
	"rebac-service/internal/lib/logger"
	"syscall"
...
func main() {
	...
	application := ssoapp.New(log, cfg.GRPSServer.Port, tlsConfig, cfg.DataBase.DSN())
