# 🪙 Transaction System (Transaction Service)
...
## 🎀 О проекте
Transaction Service - микросервис в системе платежей Transaction System, который обрабатывает и хранит транзакции платежей. 
> [!WARNING]
