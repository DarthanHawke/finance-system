...
import (
	...
	"os"
	"os/signal"
	paymentapp "payment-service/internal/app"
	"payment-service/internal/cache"
	"payment-service/internal/config"
	"payment-service/internal/events"
	"payment-service/internal/lib/logger"
...
func main() {
	...
	application := paymentapp.New(log, cfg.GRPSServer.Port, tlsConfig, cfg.DataBase.DSN(), redisCache, rabbitConn)
