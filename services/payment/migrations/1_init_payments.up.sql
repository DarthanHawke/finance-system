-- =======================================================================
-- Создание таблицы payments для хранения информации о платежах в системе
-- =======================================================================
...
CREATE TABLE payments (
    ...
    -- Тип платежа: transfer, payment, refund
    payment_type                VARCHAR(20) NOT NULL,
    -- Направление платежа: incoming и outgoing
    ...
    UNIQUE(stan, date, payment_type, sender_type)
); 
